...
**Tests**: Test tasks are REQUIRED when the constitution or feature risk profile demands
them. Backend business logic and persistence changes require automated coverage, and
critical user journeys require frontend component or integration coverage.
...
- [ ] T010 [P] Establish Docker-based local runtime and document Render free-tier constraints
...
- [ ] T013 [P] [US1] Frontend component or flow test for [journey] in frontend/tests/[name]
...
- [ ] T020 [US1] Add or update database migration and rollback notes
...
- [ ] T023 [P] [US2] Frontend component or flow test for [journey] in frontend/tests/[name]
...
- [ ] T028 [US2] Add or update database migration and rollback notes
...
- [ ] T031 [P] [US3] Frontend component or flow test for [journey] in frontend/tests/[name]
...
- [ ] T035 [US3] Add or update database migration and rollback notes
...
- [ ] TXXX [P] Accessibility and responsive-design verification
...
Task: "Frontend component or flow test for [journey] in frontend/tests/[name]"
